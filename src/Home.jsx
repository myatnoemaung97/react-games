...
export default function Home() {
  return (
    <div className="font-mono">
      ...
      <div className="max-w-[1000px] w-11/12 mx-auto mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-3 gap-y-5">
        <MenuGameCard
        ...
        <MenuGameCard
          ...
          img={tictactoe} alt={'tic-tac-toe game image'} />
